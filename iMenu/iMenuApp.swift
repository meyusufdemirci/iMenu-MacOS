...
struct iMenuApp: App {
    ...
    /// Hides Hidden items from the real menu bar (milestones 0.5 path (a)). Held
    /// here so `MainView` can `install()` it and the menu bar can toggle it while
    ...
    init() {
        ...
        // very item it read. The divider-based collapser hides Hidden items from the
        // real menu bar (milestones 0.5 path (a)).
